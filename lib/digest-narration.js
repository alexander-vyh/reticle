...
- Desktop Support is almost always one sentence with zero bullets. Only add bullets for facts a VP would want (fleet age data, notable operational changes).
...
function formatWeeklySummaryFallback(curatedData) {
  ...
  renderTeam('Corporate Systems Engineering', teams.cse, 'Routine identity lifecycle operations continued.');
  renderTeam('Desktop Support', teams.desktop, 'Normal operational activity; no notable trends or employee-impacting issues requiring attention this week.');
  renderTeam('Security (Platform & Endpoint)', teams.security, 'Routine operations continued.');
