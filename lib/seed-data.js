...
const PEOPLE = [
  { name: 'Gandalf Grey', team: 'Infrastructure' },
  { name: 'Aragorn King', team: 'Infrastructure' },
  { name: 'Samwise Brown', team: 'Infrastructure' },
  { name: 'Legolas Wood', team: 'Platform' },
  { name: "Gimli 'G' Stone", team: 'Platform' },
  { name: 'Eowyn Rider', team: 'Support' },
  { name: 'Faramir Guard', team: 'Support' },
];
