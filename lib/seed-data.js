...
const PEOPLE = [
  ...
  { name: 'Bill Price', team: 'Corporate Systems Engineering' },
  { name: 'Daniel Richardson', team: 'Corporate Systems Engineering' },
  { name: 'Geoffrey Schuette', team: 'Platform & Endpoint Security' },
  { name: "Daniel 'D' Sherr", team: 'Platform & Endpoint Security' },
  { name: 'Ken Dominiec', team: 'Desktop Support' },
  { name: 'Keshon Bowman', team: 'Desktop Support' },
];
