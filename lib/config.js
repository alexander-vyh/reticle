...
module.exports = {
  ...
  // LLM Gateway (Claude via GCP Vertex, authenticated with gcloud identity tokens)
  anthropicBaseUrl: process.env.ANTHROPIC_BASE_URL || secrets.anthropicBaseUrl || null,
