...
const DEFAULT_CACHE_PATH = path.join(process.env.RETICLE_DATA_DIR || path.join(process.env.HOME, '.reticle', 'data'), 'meeting-cache.json');
const DEFAULT_STATE_PATH = path.join(process.env.RETICLE_DATA_DIR || path.join(process.env.HOME, '.reticle', 'data'), 'alert-state.json');
