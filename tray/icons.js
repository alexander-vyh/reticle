...
function svgInnerArcs(rotation) {
  ...
  return `
  <g stroke="white" stroke-width="0.6" stroke-linecap="round" fill="none"${transform}>
...
/**
 * Build a complete SVG string for the Reticle tray icon.
...
module.exports = {
  green:  () => renderIcon(buildSvg('none')),
