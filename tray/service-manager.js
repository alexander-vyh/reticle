...
const HEARTBEAT_DIR = path.join(os.homedir(), '.reticle', 'heartbeats');

// Map launchd labels to heartbeat service names
const HEARTBEAT_NAMES = {
  'ai.reticle.gmail-monitor': 'gmail-monitor',
  'ai.reticle.slack-events': 'slack-events',
  'ai.reticle.meeting-alerts': 'meeting-alerts',
  'ai.reticle.followup-checker': 'followup-checker',
  'ai.reticle.gateway': null,  // Gateway doesn't write heartbeats (yet)
  'ai.reticle.meeting-recorder': null,  // Meeting recorder doesn't write heartbeats (yet)
  'ai.reticle.digest-daily': 'digest-daily',
  'ai.reticle.digest-weekly': 'digest-weekly',
};

const SERVICES = [
  { label: 'Gmail Monitor',      launchdLabel: 'ai.reticle.gmail-monitor' },
  { label: 'Slack Events',       launchdLabel: 'ai.reticle.slack-events' },
  { label: 'Meeting Alerts',     launchdLabel: 'ai.reticle.meeting-alerts' },
  { label: 'Follow-up Checker',  launchdLabel: 'ai.reticle.followup-checker' },
  { label: 'Meeting Recorder',   launchdLabel: 'ai.reticle.meeting-recorder' },
  { label: 'Gateway',            launchdLabel: 'ai.reticle.gateway' },
  { label: 'Daily Digest',      launchdLabel: 'ai.reticle.digest-daily', scheduled: true },
  { label: 'Weekly Digest',     launchdLabel: 'ai.reticle.digest-weekly', scheduled: true },
];
