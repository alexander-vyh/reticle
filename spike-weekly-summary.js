...
const meetingMetadata = [
  ...
  { title: 'Example.co DW Corporate Systems Engineer Interview - Peregrin Took', date: '2026-03-11', attendees: ['Peregrin Took'] },
  { title: 'Example.co DW Corporate Systems Engineer Interview - Meriadoc Brand', date: '2026-03-11', attendees: ['Meriadoc Brand'] },
  { title: 'Example.co DW Corporate Systems Engineer Interview - Elrond Half', date: '2026-03-13', attendees: ['Elrond Half'] },
...
IMPORTANT:
- Do NOT list individual ticket keys (ENG-xxxx, ENGSUP-xxxxx) in the notes.
